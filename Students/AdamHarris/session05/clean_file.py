...
def clean_file(name_fileinput, name_fileoutput):
    ...
    f_outlines = map(string.strip, f_inlines)
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Seek help menu, try again.")
        sys.exit(1)
    else:
...
clean_file_LC('/home/adamharris/sea-c28-stuff/sea-c28-students/Students/AdamHarris/session04/sherlock.txt',
